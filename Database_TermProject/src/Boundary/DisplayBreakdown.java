...
import persistenceLayer.IssueBreakdown;
 ...
 */
@WebServlet("/DisplayBreakdown")
public class DisplayBreakdown extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static  String         templateDir = "WEB-INF/templates";
	static  String         signUpTemplateName = "ByCompany.ftl";
	static  String         displayTemplateName = "IssueBreakdown.ftl";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	String issue = request.getParameter("getIssue");
			IssueBreakdown breakdown = new IssueBreakdown();
			root.put("issue", issue);
			root.put("breakdown", breakdown.getBreakdown(issue));
