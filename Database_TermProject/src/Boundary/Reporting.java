...
import persistenceLayer.Reports;
...
public class Reporting extends HttpServlet {
	...
	static  String         signUpTemplateName = "CompanyReport.ftl";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			root.put("companyName", report.companyReport(company).get(0).getCompany());
			root.put("report", report.companyReport(company));
